export default {
  ...
  riskReport: {
    ...
    screeningResults: [
      { name: 'Lumon Industries, Inc.', type: 'Primary Entity', level: 'low', redFlags: '' },
    ],
    redFlags: [],
    processSummary: [
      { step: 'Onboarding', isLink: true, status: 'Completed', by: 'Helly Riggs', date: '5 Jan 2025' },
      { step: 'Risk Assessment', isLink: true, status: 'Completed', by: 'Mark Scout', date: '6 Jan 2025' },
      { step: 'Internal Due Diligence', isLink: true, status: 'Completed', by: 'Dylan George', date: '8 Jan 2025' },
      { step: 'External Due Diligence', isLink: true, status: 'Completed', by: 'Irving Bailiff', date: '10 Jan 2025' },
      { step: 'Enhanced Due Diligence Report', isLink: true, status: 'Not Required', by: '', date: '' },
      { step: 'UBO Module', isLink: false, status: 'Completed', by: 'Mark Scout', date: '12 Jan 2025' },
      { step: 'Risk Mitigation Module', isLink: true, status: 'Completed', by: 'Harmony Cobel', date: '14 Jan 2025' },
      { step: 'Approval Module', isLink: true, status: 'Completed', by: 'Natalie Herbst', date: '15 Jan 2025' },
      { step: 'Screening and Monitoring Module', isLink: true, status: 'In Progress', by: 'Seth Milchick', date: '2 Jan 2026' },
    ],
  },
};
