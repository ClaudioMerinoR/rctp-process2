export default {
  ...
  riskReport: {
    ...
    screeningResults: [
      { name: 'Bruce Thomas Wayne', type: 'Primary Person', level: 'low', redFlags: '' },
    ],
    redFlags: [],
    processSummary: [
      { step: 'Risk Assessment', isLink: true, status: 'Completed', by: 'Lucius Fox', date: '1 Dec 2025' },
      { step: 'Integrity Check', isLink: true, status: 'In Progress', by: 'Alfred Pennyworth', date: '1 Dec 2025' },
      { step: 'Due Diligence', isLink: true, status: 'In Progress', by: 'Alfred Pennyworth', date: '5 Dec 2025' },
      { step: 'Enhanced Due Diligence Report', isLink: true, status: 'Not Required', by: '', date: '' },
      { step: 'UBO Module', isLink: false, status: 'Completed', by: 'Lucius Fox', date: '5 Dec 2025' },
