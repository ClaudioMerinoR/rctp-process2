export default {
  ...
  overviewFields: [
    { label: 'Person Third Party Legal Name', value: 'Bruce Wayne Batman' },
    { label: 'Person Industry Sector - onboarding', value: '\u2014' },
    { label: 'Third Party Owner', value: 'Claudio Merino' },
    { label: 'Process Name', value: 'Standard RCTP' },
    { label: 'Person Country of Residence', value: 'United States', flag: '\u{1F1FA}\u{1F1F8}' },
    { label: 'Third Party Contact Email Address', value: 'bruce.wayne@wayneenterprises.com' },
