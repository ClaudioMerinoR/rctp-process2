export default {
  ...
  overviewFields: [
    { label: 'Legal name', value: 'Gazprom' },
    { label: 'Industry / Sector', value: 'Energy' },
    { label: 'Third Party Owner', value: 'Tamara Knoetschke' },
    { label: 'Process Name', value: 'Standard RCTP' },
    { label: 'Country of Registration', value: 'Russia', flag: '\u{1F1F7}\u{1F1FA}' },
    { label: 'Third Party Contact Email', value: 'claudio@gazprom.com' },
  ...
  additionalFields: [
    { label: 'Also Known As', value: 'Gazmash' },
    { label: 'Responsible Client Unit', value: 'Procurement (Central, direct material)' },
    { label: 'Company Number', value: '587762367' },
    { label: 'Identification Type', value: 'DUNS Number' },
    { label: 'Address Details', value: 'Primorskiy Prospekt, 54/1A/1N' },
    ...
    { label: 'Identification Value', value: '366162464' },
    { label: 'Company Website', value: 'www.gazprom.ru', link: true, href: 'https://www.gazprom.ru' },
  ],
