export default {
  ...
  sidebarSteps: [
    ...
    { label: 'Integrity Check', dot: 'grey', partner: 'integrity', tooltip: 'Powered by Xapiens' },
  ...
  screeningRows: [
    {
      name: 'Pied Piper, Inc.',
      matches: [
        { bg: 'var(--warning-500)', color: 'var(--text-normal)', val: '8' },
        { bg: 'var(--success-500)', color: 'var(--text-normal)', val: '2' },
        { bg: 'var(--text-light)', color: '#fff', val: '0' },
        { bg: 'var(--neutral-200)', color: 'var(--text-normal)', val: '1' },
        { bg: 'var(--warning-500)', color: 'var(--text-normal)', val: '2' },
      ],
      updated: '30 Nov 2025',
      type: 'Primary Entity',
  ...
  riskReport: {
    ...
    matchResults: [
      ...
      { count: 1, bg: '#9A3438', color: '#fff', label: 'Confirmed (Matches)' },
      { count: 2, bg: '#E34C53', color: '#fff', label: 'Open (Pending Review)' },
    ],
    screeningResults: [
      { name: 'Richard Hendricks', type: 'CEO', level: 'low', redFlags: '' },
      { name: 'Gavin Belson', type: 'Adverse Party', level: 'high', redFlags: 'YES' },
      { name: 'Erlich Bachman', type: 'Former Director', level: 'medium', redFlags: 'YES' },
    ],
    redFlags: [
      { title: 'IP Ownership Dispute — Hooli / Gavin Belson', isLink: true, status: 'Open', cat: 'Bribery & Corruption' },
      { title: 'Leadership Instability — Multiple CEO Changes', isLink: false, status: 'In Progress', cat: 'General' },
      { title: 'Unregulated Decentralised Internet Protocol Risk', isLink: false, status: 'Open', cat: 'Cyber' },
    ],
    processSummary: [
      { step: 'Onboarding', isLink: true, status: 'Completed', by: 'Monica Hall', date: '15 Nov 2025' },
      { step: 'Risk Assessment', isLink: true, status: 'In Progress', by: 'Jared Dunn', date: '15 Nov 2025' },
      { step: 'Internal Due Diligence', isLink: true, status: 'In Progress', by: 'Jared Dunn', date: '20 Nov 2025' },
      ...
      { step: 'UBO Module', isLink: false, status: 'Action Required', by: 'Compliance Group', date: '1 Dec 2025' },
