export default {
  ...
  overviewFields: [
    { label: 'Legal name', value: 'Initech' },
    ...
    { label: 'Third Party Contact Email', value: 'contact@initech.com' },
    ...
    { label: 'Commercial Significance', value: '[Between 5 and 10%] / Significant / Not in top 10' },
  ...
  additionalFields: [
    ...
    { label: 'Company Number', value: 'US-98765432' },
    { label: 'Identification Type', value: 'DUNS Number' },
    { label: 'Address Details', value: '1033 US Hwy 46 Ste 201, Clifton, NJ 07013' },
    { label: 'All Relevant Client Units', value: 'Americas, Global Operations' },
    { label: 'Internal Reference or ID', value: 'INT-0042' },
    { label: 'Identification Value', value: '808241999' },
    { label: 'Company Website', value: 'www.initech.com', link: true },
  ],
