export default {
  ...
  riskReport: {
    ...
    screeningResults: [
      { name: 'Initech Corporation', type: 'Primary Entity', level: 'medium', redFlags: 4 },
    ],
    redFlags: [
      { title: 'Embezzlement Allegation — Salami Slicing Scheme', status: 'Under Review', cat: 'Bribery & Corruption', isLink: true },
      { title: 'Mass Redundancy — Downsizing Consultants Engaged', status: 'Acknowledged', cat: 'General', isLink: false },
      { title: 'Workplace Environment Complaints — Multiple Employees', status: 'Open', cat: 'Human Rights', isLink: false },
    ],
    processSummary: [
      { step: 'Onboarding', isLink: true, status: 'Completed', by: 'Bill Lumbergh', date: '5 Jan 2025' },
      { step: 'Risk Assessment', isLink: true, status: 'In Progress', by: 'Milton Waddams', date: '2 Jan 2026' },
      { step: 'Internal Due Diligence', isLink: true, status: 'Completed', by: 'Bob Porter', date: '15 Jan 2025' },
      { step: 'External Due Diligence', isLink: true, status: 'Completed', by: 'Bob Slydell', date: '20 Jan 2025' },
      { step: 'Enhanced Due Diligence Report', isLink: true, status: 'Not Required', by: '', date: '' },
      { step: 'UBO Module', isLink: false, status: 'Completed', by: 'Tom Smykowski', date: '25 Jan 2025' },
      { step: 'Risk Mitigation Module', isLink: true, status: 'Action Required', by: 'Bob Slydell', date: '15 Jan 2026' },
      { step: 'Approval Module', isLink: true, status: 'Completed', by: 'Bill Lumbergh', date: '1 Feb 2025' },
      { step: 'Screening and Monitoring Module', isLink: true, status: 'In Progress', by: 'Bob Slydell', date: '15 Jan 2026' },
    ],
  },
};
