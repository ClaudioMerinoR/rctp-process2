export default {
  ...
  riskReport: {
    ...
    screeningResults: [
      { name: 'Kendall Roy', type: 'Director', level: 'high', redFlags: 'YES' },
      { name: 'Logan Roy', type: 'Former CEO', level: 'high', redFlags: 'YES' },
      { name: 'Tom Wambsgans', type: 'CEO', level: 'medium', redFlags: 'YES' },
      { name: 'Roman Roy', type: 'Former COO', level: 'medium', redFlags: '' },
    ],
    redFlags: [
      { title: 'DOJ Investigation — Brightstar Cruises Cover-Up', isLink: true, status: 'Open', cat: 'Bribery & Corruption' },
      { title: 'ATN — Federal Election Interference Allegations', isLink: true, status: 'Open', cat: 'General' },
      { title: 'Senior Executive Misconduct — Multiple Officers', isLink: false, status: 'Open', cat: 'Human Rights' },
      { title: 'PEP Match — Kendall Roy (Politically Exposed)', isLink: true, status: 'Open', cat: 'Screening & Monitoring' },
      { title: 'Crew Abuse Allegations — Brightstar Cruises', isLink: false, status: 'In Progress', cat: 'Human Rights' },
    ],
    processSummary: [
      { step: 'Onboarding', isLink: true, status: 'Completed', by: 'Gerri Kellman', date: '1 Nov 2025' },
      { step: 'Risk Assessment', isLink: true, status: 'Completed', by: 'Emily Forbes', date: '5 Nov 2025' },
      { step: 'Internal Due Diligence', isLink: true, status: 'Completed', by: 'Emily Forbes', date: '10 Nov 2025' },
      { step: 'External Due Diligence', isLink: true, status: 'In Progress', by: 'Emily Forbes', date: '1 Dec 2025' },
      { step: 'Enhanced Due Diligence Report', isLink: true, status: 'In Progress', by: 'Emily Forbes', date: '1 Dec 2025' },
      { step: 'UBO Module', isLink: false, status: 'Action Required', by: 'Compliance Group', date: '20 Dec 2025' },
      { step: 'Risk Mitigation Module', isLink: true, status: 'Action Required', by: 'Compliance Group', date: '20 Dec 2025' },
      { step: 'Approval Module', isLink: true, status: 'Not Approved', by: 'Compliance Group', date: '29 Dec 2025' },
      { step: 'Screening and Monitoring Module', isLink: true, status: 'Action Required', by: 'Compliance Group', date: '29 Dec 2025' },
    ],
  },
};
